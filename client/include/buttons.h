...
{
public:
    Button(sf::Vector2f position, std::string texturePath, std::string text): m_position(position), m_text(text) 
    {
...
public:
    ...
    bool isMouseOver(sf::RenderWindow &window) override 
    {
        ...
        if (mousePos.x >= m_position.x && mousePos.x <= m_position.x + m_size.x && mousePos.y >= m_position.y &&
    ...
    void change_color(int color_num) 
    {
        ...
        {
            case 1: 
            {   m_rectangle.setFillColor(sf::Color::Green); break;    }
            case 2: 
            {   m_rectangle.setFillColor(sf::Color::Red); break;      }
            case 3: 
            {   m_rectangle.setFillColor(sf::Color::Blue); break;     }
            case 4:  
            {   m_rectangle.setFillColor(sf::Color::Magenta);break;   }
            case 5: 
            {   m_rectangle.setFillColor(sf::Color::Cyan);  break;    }
            case 6: 
            {   m_rectangle.setFillColor(sf::Color::Yellow); break;   }
            default: 
...
public:
    ...
    void change_color(int color_num) 
    {
        ...
        {
            case 1: 
            {   m_circle.setFillColor(sf::Color::Green); break;    }
            case 2: 
            {   m_circle.setFillColor(sf::Color::Red); break;      }
            case 3: 
            {   m_circle.setFillColor(sf::Color::Blue); break;     }
            case 4:  
            {   m_circle.setFillColor(sf::Color::Magenta);break;   }
            case 5: 
            {   m_circle.setFillColor(sf::Color::Cyan);  break;    }
            case 6: 
            {   m_circle.setFillColor(sf::Color::Yellow); break;   }
            default: 
